...
class Tortek {
    ...
    public:
        ...
        void tortetbeker(){
            cout << "Kerem a szamokat 12 15 alakban: ";
            cin >> szamlalo >> nevezo;
        }
        int szamlalotad(){
            return szamlalo;
    ...
    public:
        ...
        void szoroz(){
            eredmeny.tortetfeltolt(
                tort1.szamlalotad()* tort2.szamlalotad(),
                tort1.nevezotad()* tort2.nevezotad());
        }
        void adatotfeltolt(int sz1, int n1, int sz2, int n2, char m){
...
class Osszeadasok : public Muveletek {
    private:
        Tortek resz1;
        Tortek resz2;
    public:
